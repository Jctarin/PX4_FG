...
Decline_vector= np.array([[ 47, 46, 45, 43, 42, 41, 39, 37, 33, 29, 23, 16, 10, 4, -1, -6, -10, -15, -20, -27, -34, -42, -49, -56, -62, -67, -72, -74, -75, -73, -61, -22, 26, 42, 47, 48, 47 ],
...
inclination_vector=np.array([[ -78, -76, -74, -72, -70, -68, -65, -63, -60, -57, -55, -54, -54, -55, -56, -57, -58, -59, -59, -59, -59, -60, -61, -63, -66, -69, -73, -76, -79, -83, -86, -87, -86, -84, -82, -80, -78 ],
...
strength_vector=np.array([[ 62, 60, 58, 56, 54, 52, 49, 46, 43, 41, 38, 36, 34, 32, 31, 31, 30, 30, 30, 31, 33, 35, 38, 42, 46, 51, 55, 59, 62, 64, 66, 67, 67, 66, 65, 64, 62 ],
...
def Indice_tabla(val,min_val,max_val):
    val=Constrain(val,min_val,max_val)
    val=abs((-(min_val)+val)/SAMPLING_RES)
    return val

def val_tabla(lat,lon,tabla):
...
def mag_Declination(lat,lon):
    return val_tabla(lat,lon,Decline_vector)

def mag_Inclination(lat,lon):
    return val_tabla(lat,lon,inclination_vector)

def mag_strength(lat,lon):
    return val_tabla(lat,lon,strength_vector)